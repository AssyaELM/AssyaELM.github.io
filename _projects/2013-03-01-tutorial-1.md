...
<figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/swi.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/swi.jpg" alt="Switch" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); margin: 0 auto; display: block;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0; display: block; width: 100%;">Switch – Clique pour voir en grand</figcaption>
</figure>
