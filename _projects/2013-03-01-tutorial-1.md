...
<figure style="text-align: center; margin: 3em 0; padding: 0; display: inline-block;">
  ...
  <figcaption style="display: block; margin-top: 18px; font-size: 1.1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
    Topologie du réseau local – Clique pour voir en grand
  </figcaption>
</figure>
...
<figure style="text-align: center; margin: 2em 0; display: inline-block;">
  <img src="/files/login.jpg" 
       alt="Page de login" 
       style="width: 40%; max-width: 300px; height: auto; display: block; margin: 0 auto; border: 1px solid #ccc; border-radius: 8px;">
  <figcaption style="display: block; font-size: 0.9em; color: #555; margin-top: 0.5em;">
