...
<figure style="text-align: center; margin: 3em 0; padding: 0;">
  <a href="/files/local.jpg" target="_blank" rel="noopener">
    <img src="/files/local.jpg" 
         alt="Topologie du réseau local" 
         style="max-width: 980px; width: 100%; height: auto; border-radius: 16px; box-shadow: 0 15px 40px rgba(0,0,0,0.22); transition: all 0.4s ease; border: 2px solid #1a1a1a;">
  </a>
  <figcaption style="margin-top: 18px; font-size: 1.1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
