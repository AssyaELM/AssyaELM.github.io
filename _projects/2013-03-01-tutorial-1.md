...
<figure style="text-align: center; margin: 2em 0;">
  <a href="/files/local.jpg" target="_blank">
    <img src="/files/local.jpg" 
         alt="Topologie du réseau local" 
         style="max-width: 750px; width: 100%; height: auto; border-radius: 12px; box-shadow: 0 8px 25px rgba(0,0,0,0.15); transition: all 0.3s ease;">
  </a>
  <figcaption style="margin-top: 12px; font-style: italic; color: #555; font-size: 0.95em;">
    Topologie du réseau local – Clique pour agrandir
  </figcaption>
</figure>
