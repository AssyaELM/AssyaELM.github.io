...
- **Gestion des Switches (gestion_switches.php)** : Une interface CRUD (Create, Read, Update, Delete) complète pour ajouter, modifier ou supprimer les switchs à superviser.  
 <figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/swi.jpg" target="_blank" rel="noopener" style="display: inline-block;">
    <img src="/files/swi.jpg" alt="Gestion des switchs"
         style="max-width: 70%; height: auto; cursor: pointer; border-radius: 16px;
                box-shadow: 0 10px 25px rgba(0,0,0,0.2); display: block; margin: 0 auto;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600;
...
<figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/hist.jpg" target="_blank" rel="noopener" style="display: inline-block;">
    <img src="/files/hist.jpg" alt="Historique"
         style="max-width: 70%; height: auto; cursor: pointer; border-radius: 16px;
                box-shadow: 0 10px 25px rgba(0,0,0,0.2); display: block; margin: 0 auto;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600;
                     color: #e0e0e0; display: block; width: 100%;">
    Historique – Clique pour voir en grand
  </figcaption>
</figure>
