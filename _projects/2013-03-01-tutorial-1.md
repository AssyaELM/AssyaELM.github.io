...
**********
 <figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/swi.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/swi.jpg" alt="Port" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); margin: 0 auto; display: block;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0; display: block; width: 100%;"> Page de gestion des switchs – Clique pour voir en grand</figcaption>
</figure>
- **État Détaillé des Ports (etat_ports.php)** : Permet de sélectionner un switch et d'afficher un tableau détaillé de l'état de chacun de ses ports en temps réel. 
  <figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/port.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/port.jpg" alt="Port" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); margin: 0 auto; display: block;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0; display: block; width: 100%;">Port – Clique pour voir en grand</figcaption>
</figure>
...
<figure style="margin: 1em 0; padding: 0; text-align: center; display: block;">
  <a href="/files/hist.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/hist.jpg" alt="Historique" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); margin: 0 auto; display: block;">
  </a>
  <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0; display: block; width: 100%;">Historique – Clique pour voir en grand</figcaption>
</figure>
---
...
<figure style="text-align: center; margin: 1em 0; padding: 0; display: inline-block;">
  <a href="/files/alerte.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/alerte.jpg" 
         alt="Système d'alerte" 
         style="max-width: 980px; width: 100%; height: auto; border-radius: 16px; box-shadow: 0 15px 40px rgba(0,0,0,0.22); transition: all 0.4s ease; display: block; margin: 0 auto;">
  </a>
  <figcaption style="display: block; margin-top: 8px; font-size: 1.1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
    Système d'alerte – Clique pour voir en grand
  </figcaption>
</figure>
3. **Rapports PDF Quotidiens** : Un script (`generate_report.php`), exécuté chaque jour via une tâche planifiée (CRON sur Planificateur de tâches sur Windows) utilise la bibliothèque TCPDF pour générer un rapport PDF. Ce rapport résume l'état du réseau, les alertes des dernières 24 heures et est automatiquement envoyé sur le même canal Telegram.  
<figure style="text-align: center; margin: 1em 0; padding: 0; display: inline-block;">
  <a href="/files/report0.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/report0.jpg" 
         alt="Rapport" 
         style="max-width: 980px; width: 100%; height: auto; border-radius: 16px; box-shadow: 0 15px 40px rgba(0,0,0,0.22); transition: all 0.4s ease; display: block; margin: 0 auto;">
  </a>
  <figcaption style="display: block; margin-top: 8px; font-size: 1.1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
    Rapport – Clique pour voir en grand
  </figcaption>
</figure>
<div style="display: flex; justify-content: center; gap: 20px; margin: 1em 0;">
  <figure style="margin: 0; padding: 0;">
    <a href="/files/telegramreport.png" target="_blank" rel="noopener" style="display: block;">
      <img src="/files/telegramreport.png" alt="Rapport Telegram 1" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
    </a>
    <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0;">Rapport Telegram 1 – Clique pour voir en grand</figcaption>
  </figure>
  <figure style="margin: 0; padding: 0;">
    <a href="/files/telegramreport2.png" target="_blank" rel="noopener" style="display: block;">
      <img src="/files/telegramreport2.png" alt="Rapport Telegram 2" style="max-width: 100%; height: auto; cursor: pointer; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
    </a>
    <figcaption style="margin-top: 8px; text-align: center; font-weight: 600; color: #e0e0e0;">Rapport Telegram 2 – Clique pour voir en grand</figcaption>
  </figure>
</div>
---
