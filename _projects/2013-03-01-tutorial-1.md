...
<div style="display: flex; justify-content: center; margin: 3em 0;">
  <figure style="text-align: center; margin: 0; padding: 0; width: fit-content;">
    <a href="/files/local.jpg" target="_blank" rel="noopener">
      <img src="/files/local.jpg" 
           alt="Topologie du réseau local" 
           style="max-width: 980px; width: 100%; height: auto; border-radius: 18px; box-shadow: 0 16px 45px rgba(0,0,0,0.28); transition: all 0.4s ease; border: 3px solid #2a9d8f;">
    </a>
    <figcaption style="margin-top: 20px; font-size: 1.15em; font-weight: 700; color: #ffffff; background: rgba(0,0,0,0.4); padding: 12px 20px; border-radius: 12px; display: inline-block;">
