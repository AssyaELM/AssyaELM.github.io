...
<figure style="text-align: center; margin: 3em 0; padding: 0; display: inline-block;">
  <a href="/files/local.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/local.jpg" 
         ...
         style="max-width: 980px; width: 100%; height: auto; border-radius: 16px; box-shadow: 0 15px 40px rgba(0,0,0,0.22); transition: all 0.4s ease; border: 2px solid #1a1a1a; display: block; margin: 0 auto;">
  </a>
  <figcaption style="display: block; margin-top: 18px; font-size: 1.1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
...
<figure style="text-align: center; margin: 2em 0; padding: 0; display: inline-block;">
  <a href="/files/login.jpg" target="_blank" rel="noopener" style="display: block;">
    <img src="/files/login.jpg" 
         alt="Page de login" 
         style="width: 40%; max-width: 300px; height: auto; display: block; margin: 0 auto; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); border: 2px solid #1a1a1a; transition: all 0.3s ease;">
  </a>
  <figcaption style="display: block; margin-top: 12px; font-size: 1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin: 2em 0;">
  <figure style="text-align: center; margin: 0;">
    <a href="/files/acc.jpg" target="_blank" rel="noopener" style="display: block;">
      <img src="/files/acc.jpg" 
           alt="Page d'accueil" 
           style="max-width: 100%; width: 300px; height: auto; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); border: 2px solid #1a1a1a; transition: all 0.3s ease; display: block; margin: 0 auto;">
    </a>
    <figcaption style="margin-top: 12px; font-size: 1em; font-weight: 600; color: #e0e0e0; font-family: 'Segoe UI', sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
      Page d'accueil 1 
    </figcaption>
  </figure>
