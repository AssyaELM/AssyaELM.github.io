...
{% include figure image_path="/files/gestion.jpg" alt="Interface de gestion des switches" caption="Capture d’écran – Interface de gestion des switches (gestion_switches.php)" %}
