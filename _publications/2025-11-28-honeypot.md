...
<div style="text-align:center; margin: 3rem 0;">
  <a href="{{ '/files/3alerte.png' | relative_url }}" target="_blank">
    <img src="{{ '/files/3alerte.png' | relative_url }}"
         alt="Capture réelle d’une alerte Telegram reçue en direct"
         style="max-width:100%; border:1px solid #333; border-radius:12px; box-shadow: 0 8px 20px rgba(0,0,0,0.3); cursor:zoom-in;">
  </a>
  <p><em>Capture réelle d’une alerte Telegram envoyée en temps réel lors d’une attaque brute-force détectée</em></p>
</div>
...
- Logstash (ou Filebeat, selon la configuration choisie) lit ces fichiers et les envoie vers Elasticsearch après éventuellement quelques transformations (ajout de champs, parsing, normalisation).  
...
Cette plateforme constitue une base solide pour poursuivre des travaux en cybersécurité offensive et défensive, améliorer la connaissance des menaces et expérimenter des stratégies de détection et de réponse toujours plus efficaces.
